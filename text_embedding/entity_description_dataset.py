...
class EntityDescriptionDataset(Dataset):
    ...
    def __init__(self, input_file: str, instruction : str):
    ...
    def _load_data(self):
        with open(self.input_file, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                self.data.append(self.instruction+entity_description)
...
def create_description_dataloader(input_file: str, instruction : str, batch_size: int, shuffle: bool = False):
